 ...
 *  parses to a valid decimal. No coroutines, no ViewModel — ported verbatim from desktop's
 *  `AlertFormState.kt` (`desktopApp/.../watchlist/AlertFormState.kt`), unit-tested in isolation.
 *
