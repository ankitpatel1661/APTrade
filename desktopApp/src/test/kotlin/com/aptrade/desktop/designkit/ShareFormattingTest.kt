...
/** [formatShares] display contract: at most 4 decimal places, HALF_AWAY_FROM_ZERO
 *  rounding, trailing zeros trimmed. Ledger precision is never touched — this is a
 *  render-only helper (PortfolioViewModel rows, IncomePane share labels). */
